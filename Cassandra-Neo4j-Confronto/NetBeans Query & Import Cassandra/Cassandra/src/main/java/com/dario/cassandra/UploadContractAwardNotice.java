 ...
 * @author Dario
 */
public class UploadContractAwardNotice {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Map<String, ContractAwardNotice> mappa = new HashMap<String, ContractAwardNotice>();
        ContractAwardNotice contractNotice;
        Reader reader;
        ...
        try {
            ...
            for (CSVRecord csvRecord : csvParser) {
                ...
                if(!id_notice_can.equals("")){
                    contractNotice = mappa.get(id_notice_can);
                    if (contractNotice == null) {
                        contractNotice = new ContractAwardNotice();
                        ...
                        List<ContractAwardNotice> listainserimento = new ArrayList<ContractAwardNotice>(mappa.values());
                        JavaRDD<ContractAwardNotice> parallelize = sc.parallelize(listainserimento);
                        CassandraJavaUtil.javaFunctions(parallelize)
                        .writerBuilder("database2", "contract_award_notice", mapToRow(ContractAwardNotice.class)).saveToCassandra();
                    }
